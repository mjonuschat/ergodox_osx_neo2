...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FKEYS] = LAYOUT_ergodox(
    ...
    KC_MEDIA_REWIND,        _______,            _______,            _______,              _______,            _______,            _______,
    KC_MEDIA_PLAY_PAUSE,    _______,            _______,            _______,              _______,            _______,            /* --- */
    KC_MEDIA_FAST_FORWARD,  _______,            _______,            _______,              _______,            _______,            _______,
    _______,                _______,            _______,            _______,              _______,            /* --- */           /* --- */
    ...
    _______,                _______,            _______,            _______,              _______,            _______,            KC_AUDIO_VOL_UP,
    /* --- */               _______,            _______,            _______,              _______,            _______,            KC_AUDIO_VOL_DOWN,
    _______,                _______,            _______,            _______,              _______,            _______,            KC_AUDIO_MUTE,
    /* --- */               /* --- */           _______,            _______,              _______,            _______,            _______,
